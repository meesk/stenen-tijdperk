...
public class LocatieFactory {
	...
	public LocatieFactory() throws RemoteException {
		...
		locaties.add(new Beschavingskaart(653, 438, 85, 145, Arrays.asList(new Point(47, 31)), 2));
		locaties.add(new Beschavingskaart(560, 438, 85, 145, Arrays.asList(new Point(47, 32)), 1));
